...
def get_invoices():
    ...
    Query parameters:
    - status: paid, partial, unpaid, all (default: all)
    - date_filter: today, yesterday, week, month, custom, all (default: all)
    - custom_date: YYYY-MM-DD (required if date_filter=custom)
    - date_from: YYYY-MM-DD (alternative date range start)
    - date_to: YYYY-MM-DD (alternative date range end)
